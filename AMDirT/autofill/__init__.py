...
def run_autofill(local: AnyStr, remote: AnyStr, schema: AnyStr):
	...
	for sample in diff[0]:
		api_result = e.query(sample, fields=["first_public","sample_alias","study_accession","secondary_sample_accession","library_name","instrument_platform","library_layout","library_strategy","read_count","run_accession","sra_ftp","sra_md5"])
